...
-- Button-Definitionen
local buttons = {
    {text = "RTU", x = 2, y = 2, command = "osapps/ccmsi install rtu main"},
    {text = "Reaktor-PLC", x = 2, y = 5, command = "osapps/ccmsi install reactor-plc main"},
    {text = "Coordinator", x = 2, y = 8, command = "osapps/ccmsi install coordinator main"},
    {text = "Supervisor", x = 2, y = 11, command = "osapps/ccmsi install supervisor main"}
}
