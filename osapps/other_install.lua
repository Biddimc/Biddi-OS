...
-- Button-Definitionen
local buttons = {
    {text = "CPU Usage", x = 2, y = 2, command = "wget https://raw.githubusercontent.com/Biddimc/BiddiOS/refs/heads/main/osapps/item_display.lua startup.lua"},
    {text = "WIP", x = 2, y = 5, command = ""},
}
